...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{ URL::asset('/') }}assets/admin/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
    </div>
...
<!-- jQuery -->
<script src="{{ URL::asset('/') }}assets/admin/plugins/jquery/jquery.js"></script>
<!-- jQuery UI 1.11.4 -->
